...
public class AndroidSearchPageObject extends SearchPageObject {
    static {
    SEARCH_SKIP_LINK ="id:org.wikipedia:id/fragment_onboarding_skip_button";
    ...
    SEARCH_RESULTS_IN_LIST_BY_TITLE_TPL ="xpath://*[@resource-id='org.wikipedia:id/page_list_item_title'][contains(@text,'{TITLE}')]";
